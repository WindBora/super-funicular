...
\begin{figure}[!t]
 ...
 pale coordinate axes at $x=0$ and $y=0$ are the symmetry axis and mean line;
 the tick-ended orange segment denotes the corrugation height $h$.  The
...
\begin{figure*}[!t]
 ...
 ($N=256$), the method of analytical regularization~\cite{nosich1999,nosich2016} (256 modes, $Q=2048$), and a
 pulse-basis method of moments~\cite{harrington1967,hatamzadeh2008} (MoM; 192 elements); the dash-dotted line is the
 geometrical-optics (GO) limit; the coincident $kL=0.25$ value
 ($\simeq1.376$) lies above the displayed ordinate.}
...
convergence in the $L^2$-norm and demonstrated the agreement with two other
...
\bibitem{nosich1999}
A.~I. Nosich, ``The method of analytical regularization in wave-scattering and
eigenvalue problems: Foundations and review of solutions,'' \emph{IEEE
Antennas Propag. Mag.}, vol. 41, no. 3, pp. 34--49, Jun. 1999,
doi: 10.1109/74.775246.

\bibitem{nosich2016}
A.~I. Nosich, ``Method of analytical regularization in computational
photonics,'' \emph{Radio Sci.}, vol. 51, no. 8, pp. 1421--1430, Aug. 2016,
doi: 10.1002/2016RS006044.

\bibitem{harrington1967}
R.~F. Harrington, ``Matrix methods for field problems,'' \emph{Proc. IEEE},
vol. 55, no. 2, pp. 136--149, Feb. 1967,
doi: 10.1109/PROC.1967.5433.

\bibitem{hatamzadeh2008}
S. Hatamzadeh-Varmazyar, M. Naser-Moghadasi, and Z. Masouri, ``A moment
method simulation of electromagnetic scattering from conducting bodies,''
\emph{Prog. Electromagn. Res.}, vol. 81, pp. 99--119, 2008,
